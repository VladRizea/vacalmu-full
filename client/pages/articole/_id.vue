<template>
  <div class="container">
    ...
    <br>
    <p class="small-text">Articol de <a style="font-weight: bold;" class="small-text" :href="'/publishers/' + article.user.name">{{article.user.name}}</a> in categoria <a style="font-weight: bold;" class=" small-text" :href="'/categorii/' + article.category">{{article.category}}</a> </p>
    <br>
